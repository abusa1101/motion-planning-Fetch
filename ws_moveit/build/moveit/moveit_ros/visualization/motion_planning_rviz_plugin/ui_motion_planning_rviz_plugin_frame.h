...
public:
    ...
    void setupUi(QWidget *MotionPlanningUI)
    {
        ...
        planning_pipeline_combo_box->setObjectName(QStringLiteral("planning_pipeline_combo_box"));
        ...
        velocity_scaling_factor->setSingleStep(0.1);
        ...
        acceleration_scaling_factor->setSingleStep(0.1);
        ...
        shape_size_x_spin_box->setObjectName(QStringLiteral("shape_size_x_spin_box"));
        ...
        shape_size_x_spin_box->setSingleStep(0.05);
        shape_size_x_spin_box->setValue(0.2);

        horizontalLayout_16->addWidget(shape_size_x_spin_box);

        shape_size_z_spin_box = new QDoubleSpinBox(groupBox_4);
        shape_size_z_spin_box->setObjectName(QStringLiteral("shape_size_z_spin_box"));
        ...
        shape_size_z_spin_box->setSingleStep(0.05);
        shape_size_z_spin_box->setValue(0.2);

        horizontalLayout_16->addWidget(shape_size_z_spin_box);

        shape_size_y_spin_box = new QDoubleSpinBox(groupBox_4);
        shape_size_y_spin_box->setObjectName(QStringLiteral("shape_size_y_spin_box"));
        ...
        shape_size_y_spin_box->setSingleStep(0.05);
        shape_size_y_spin_box->setValue(0.2);
        ...
        shapes_combo_box->setObjectName(QStringLiteral("shapes_combo_box"));
        ...
        add_object_button->setObjectName(QStringLiteral("add_object_button"));
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/icons/edit-clear.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        object_x->setMinimum(-999.99);
        object_x->setMaximum(999.99);
        ...
        object_y->setMinimum(-999.99);
        object_y->setMaximum(999.99);
        ...
        object_z->setMinimum(-999.99);
        object_z->setMaximum(999.99);
        ...
        export_scene_geometry_text_button->setObjectName(QStringLiteral("export_scene_geometry_text_button"));
        ...
        import_scene_geometry_text_button->setObjectName(QStringLiteral("import_scene_geometry_text_button"));
    ...
    void retranslateUi(QWidget *MotionPlanningUI)
    {
        ...
        plan_and_execute_button->setText(QApplication::translate("MotionPlanningUI", "Plan && E&xecute", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        stop_button->setToolTip(QApplication::translate("MotionPlanningUI", "Stop execution by sending a stop command to the move_group.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        path_constraints_combo_box->setToolTip(QApplication::translate("MotionPlanningUI", "Select path constraints from the database. ", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        groupBox_10->setTitle(QApplication::translate("MotionPlanningUI", "Options", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        label_9->setToolTip(QApplication::translate("MotionPlanningUI", "Total time allowed for planning.  Planning stops if time or number of attempts is exceeded, or goal is reached.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_9->setText(QApplication::translate("MotionPlanningUI", "Planning Time (s):", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        planning_time->setToolTip(QApplication::translate("MotionPlanningUI", "Total time allowed for planning.  Planning stops if time or number of attempts is exceeded, or goal is reached.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        label_10->setToolTip(QApplication::translate("MotionPlanningUI", "Allowed number of planning attempts. Planning stops if time or number of attempts is exceeded, or goal is reached.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_10->setText(QApplication::translate("MotionPlanningUI", "Planning Attempts:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        planning_attempts->setToolTip(QApplication::translate("MotionPlanningUI", "Allowed number of planning attempts. Planning stops if time or number of attempts is exceeded, or goal is reached.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        label_11->setToolTip(QApplication::translate("MotionPlanningUI", "Factor (between 0 and 1) to scale down maximum joint velocities", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_11->setText(QApplication::translate("MotionPlanningUI", "Velocity Scaling:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        velocity_scaling_factor->setToolTip(QApplication::translate("MotionPlanningUI", "Factor (between 0 and 1) to scale down maximum joint velocities", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        label_20->setToolTip(QApplication::translate("MotionPlanningUI", "Factor (between 0 and 1) to scale down maximum joint accelerations", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_20->setText(QApplication::translate("MotionPlanningUI", "Accel. Scaling:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        acceleration_scaling_factor->setToolTip(QApplication::translate("MotionPlanningUI", "Factor (between 0 and 1) to scale down maximum joint accelerations", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
"\n"
" This does not plan around obstacles. ", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
"\n"
"This is usually achieved by random seeding, which can flip the robot configuration (e.g. elbow up/down). Note that motion planning is always collision-aware, regardless of this checkbox.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        collision_aware_ik->setText(QApplication::translate("MotionPlanningUI", "Collision-aware IK", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        approximate_ik->setToolTip(QApplication::translate("MotionPlanningUI", "Allow approximate IK solutions, which deviate from the target pose. Useful when an exact solution cannot be found, e.g. for underactuated arms or when trying to reach an unreachable target.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        approximate_ik->setText(QApplication::translate("MotionPlanningUI", "Approx IK Solutions", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        allow_external_program->setToolTip(QApplication::translate("MotionPlanningUI", "Allow other nodes to control start and end poses as well as planning and execution, using ROS topics (/rviz/moveit/ ).", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        allow_external_program->setText(QApplication::translate("MotionPlanningUI", "External Comm.", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        allow_replanning->setToolTip(QApplication::translate("MotionPlanningUI", "EXPERIMENTAL: Trigger replanning if new collisions are detected during plan execution. Only works for the \"Plan & Execute\" button. ", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        allow_replanning->setText(QApplication::translate("MotionPlanningUI", "Replanning", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        allow_looking->setToolTip(QApplication::translate("MotionPlanningUI", "EXPERIMENTAL: Allows the robot to reposition its sensor to look around to resolve apparent collisions. A sensor needs to be set up and the new measurements have to affect the collision scene, otherwise it has no effect. See tutorial.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        allow_looking->setText(QApplication::translate("MotionPlanningUI", "Sensor Positioning", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        collision_objects_list->setToolTip(QApplication::translate("MotionPlanningUI", "Press Ctrl+C to duplicate an object", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        groupBox_4->setTitle(QApplication::translate("MotionPlanningUI", "Add/Remove scene object(s)", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        shape_size_x_spin_box->setToolTip(QApplication::translate("MotionPlanningUI", "x dimension", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        shape_size_z_spin_box->setToolTip(QApplication::translate("MotionPlanningUI", "y dimension", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        shape_size_y_spin_box->setToolTip(QApplication::translate("MotionPlanningUI", "z dimension", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        add_object_button->setToolTip(QApplication::translate("MotionPlanningUI", "Add object at scene's origin", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        add_object_button->setText(QApplication::translate("MotionPlanningUI", "Add", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        remove_object_button->setToolTip(QApplication::translate("MotionPlanningUI", "Remove selected object", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        remove_object_button->setText(QApplication::translate("MotionPlanningUI", "Del", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        clear_scene_button->setToolTip(QApplication::translate("MotionPlanningUI", "Clear planning scene", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        clear_scene_button->setText(QApplication::translate("MotionPlanningUI", "Clr", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        pose_scale_group_box->setToolTip(QApplication::translate("MotionPlanningUI", "Change the pose and scale of the selected object", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        pose_scale_group_box->setTitle(QApplication::translate("MotionPlanningUI", "Change object pose/scale", Q_NULLPTR));
        label_4->setText(QApplication::translate("MotionPlanningUI", "Position: ", Q_NULLPTR));
        label_13->setText(QApplication::translate("MotionPlanningUI", "Rotation:", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        groupBox_5->setToolTip(QApplication::translate("MotionPlanningUI", "Describes the selected object's pose, geometry and subframes.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        publish_current_scene_button->setText(QApplication::translate("MotionPlanningUI", "&Publish", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        export_scene_geometry_text_button->setToolTip(QApplication::translate("MotionPlanningUI", "Export scene geometry to a .scene file (only geometry information is preserved)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        export_scene_geometry_text_button->setText(QApplication::translate("MotionPlanningUI", "&Export", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        import_scene_geometry_text_button->setToolTip(QApplication::translate("MotionPlanningUI", "Import scene geometry from a .scene file (only geometry information is preserved)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        import_scene_geometry_text_button->setText(QApplication::translate("MotionPlanningUI", "&Import", Q_NULLPTR));
        ...
        groupBox_15->setTitle(QApplication::translate("MotionPlanningUI", "Stored Robot States", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        load_state_button->setToolTip(QApplication::translate("MotionPlanningUI", "Load a robot state", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        load_state_button->setText(QApplication::translate("MotionPlanningUI", "Load", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        clear_states_button->setToolTip(QApplication::translate("MotionPlanningUI", "Clear robot states from list", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        clear_states_button->setText(QApplication::translate("MotionPlanningUI", "Clear", Q_NULLPTR));
        groupBox_16->setTitle(QApplication::translate("MotionPlanningUI", "Selected Robot State", Q_NULLPTR));
        ...
        groupBox_17->setTitle(QApplication::translate("MotionPlanningUI", "Current Robot State", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        save_start_state_button->setToolTip(QApplication::translate("MotionPlanningUI", "Save the current start state", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        save_start_state_button->setText(QApplication::translate("MotionPlanningUI", "Save Start", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        save_goal_state_button->setToolTip(QApplication::translate("MotionPlanningUI", "Save the current goal state", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
