...
"""autogenerated by genpy from fetchit_challenge/SchunkMachineActionResult.msg. Do not edit."""
import codecs
import sys
...
class SchunkMachineActionResult(genpy.Message):
  _md5sum = "1471476fb0fc7d1ce25819ffcafc3f6d"
  _type = "fetchit_challenge/SchunkMachineActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','fetchit_challenge/SchunkMachineResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SchunkMachineActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = fetchit_challenge.msg.SchunkMachineResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = fetchit_challenge.msg.SchunkMachineResult()
