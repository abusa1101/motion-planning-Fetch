...
"""autogenerated by genpy from fetchit_challenge/SchunkMachineAction.msg. Do not edit."""
import codecs
import sys
...
class SchunkMachineAction(genpy.Message):
  _md5sum = "db94fb16d0c2fd0f5296ba30f710658f"
  _type = "fetchit_challenge/SchunkMachineAction"
...
"""
  ...
  _slot_types = ['fetchit_challenge/SchunkMachineActionGoal','fetchit_challenge/SchunkMachineActionResult','fetchit_challenge/SchunkMachineActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SchunkMachineAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = fetchit_challenge.msg.SchunkMachineActionGoal()
      if self.action_result is None:
        self.action_result = fetchit_challenge.msg.SchunkMachineActionResult()
      if self.action_feedback is None:
        self.action_feedback = fetchit_challenge.msg.SchunkMachineActionFeedback()
    else:
      self.action_goal = fetchit_challenge.msg.SchunkMachineActionGoal()
      self.action_result = fetchit_challenge.msg.SchunkMachineActionResult()
      self.action_feedback = fetchit_challenge.msg.SchunkMachineActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_4I().pack(_x.action_goal.goal.state, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.state, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_4I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
