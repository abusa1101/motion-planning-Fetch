...
"""autogenerated by genpy from fetchit_challenge/SickCameraActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class SickCameraActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "fetchit_challenge/SickCameraActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','fetchit_challenge/SickCameraFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SickCameraActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = fetchit_challenge.msg.SickCameraFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = fetchit_challenge.msg.SickCameraFeedback()
