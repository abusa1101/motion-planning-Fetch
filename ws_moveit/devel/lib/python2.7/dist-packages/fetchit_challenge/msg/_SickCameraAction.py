...
"""autogenerated by genpy from fetchit_challenge/SickCameraAction.msg. Do not edit."""
import codecs
import sys
...
class SickCameraAction(genpy.Message):
  _md5sum = "4fdf22fdd631dbeeed6db0b9096717af"
  _type = "fetchit_challenge/SickCameraAction"
...
"""
  ...
  _slot_types = ['fetchit_challenge/SickCameraActionGoal','fetchit_challenge/SickCameraActionResult','fetchit_challenge/SickCameraActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SickCameraAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = fetchit_challenge.msg.SickCameraActionGoal()
      if self.action_result is None:
        self.action_result = fetchit_challenge.msg.SickCameraActionResult()
      if self.action_feedback is None:
        self.action_feedback = fetchit_challenge.msg.SickCameraActionFeedback()
    else:
      self.action_goal = fetchit_challenge.msg.SickCameraActionGoal()
      self.action_result = fetchit_challenge.msg.SickCameraActionResult()
      self.action_feedback = fetchit_challenge.msg.SickCameraActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_4I().pack(_x.action_goal.goal.trigger, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.trigger, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_4I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
