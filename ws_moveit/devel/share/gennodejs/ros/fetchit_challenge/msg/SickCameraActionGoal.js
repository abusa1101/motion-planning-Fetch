...
class SickCameraActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SickCameraGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SickCameraActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = SickCameraGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new SickCameraGoal()
    }
...
module.exports = SickCameraActionGoal;
